...
bool App3d::initScene() {
	...
	addCamera(
		...
		addFirstPersonNode(FirstPersonCtrl::create(sml::vec3f(0.0f, 0.0f, -10.0f)))
	);
...
//	call AppBase::update() here so that the camera gets build properly
	return AppBase::update(dt);
}
