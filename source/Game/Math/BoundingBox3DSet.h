...
struct BoundingBox3D
{
	...
	//Whether the bounding box is already axis-aligned
	bool aabb;
};
...
public:
	...
	int Size();
	const BoundingBox3D* GetBoundingBox(int index);
	...
	int IntersectRay(glm::vec3 ray1, glm::vec3 ray2, float &distance, Transformation transformation);
	int IntersectFrustum(Frustum frustum, Transformation transformation);
private:
